...
> **لم يعد له موضوع.** كان مقترحاً تعطيل الفهرس المفرد الافتراضي على
> `monthlyAnalytics.month`، ولم يُطبَّق التجاوز فعلياً قط. ثم **أُزيلت مجموعة
> `monthlyAnalytics` نفسها** ضمن تنظيف الأساس المالي، فلا فهرس مطلوباً لها
> ولا استعلام. مذكور هنا كسجلّ تاريخي فقط.
>
> ولا يلزم فهرس بديل: لا استعلام قائم يحتاجه.
